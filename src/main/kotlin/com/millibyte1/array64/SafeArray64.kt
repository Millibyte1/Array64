...
class SafeArray64<E> : Array64<E> {
    ...
    override fun copy(): SafeArray64<E> = SafeArray64(this)
   ...
   override operator fun get(index: Long): E {
    ...
    companion object {
         ...
         */
        inline operator fun <reified E> invoke(size: Long, crossinline init: (Long) -> E): SafeArray64<E> = makeTypedArray64(size, init)
