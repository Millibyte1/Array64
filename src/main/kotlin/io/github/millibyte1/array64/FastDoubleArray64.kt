...
open class FastDoubleArray64 : DoubleArray64 {
     ...
     * @throws IllegalArgumentException if [size] is not between 1 and [MAX_SIZE]
     */
    constructor(size: Long, init: (Long) -> Double) : this(size) {
    ...
    override operator fun iterator(): DoubleArray64Iterator = Iterator(this, 0)
     ...
     */
    private class Iterator(private val array: FastDoubleArray64, index: Long) : DoubleArray64Iterator() {
