 ...
 *
 */
class SafeByteArray64 : ByteArray64 {
    ...
    constructor(array: SafeByteArray64) : this(array.array)
    ...
    override fun copy(): SafeByteArray64 = SafeByteArray64(this)
    ...
    override operator fun iterator(): ByteIterator = ByteArray64Iterator(this, 0)
...
private class ByteArray64Iterator(val array: SafeByteArray64, var index: Long) : ByteIterator() {
