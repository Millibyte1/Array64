...
class FastDoubleArray64 : DoubleArray64 {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        while(thisIterator.hasNext()) if(thisIterator.nextDouble() != otherIterator.nextDouble()) return false
        return true
    }
    ...
    override operator fun iterator(): DoubleArray64Iterator = FastDoubleArray64Iterator(this, 0)
    ...
    companion object {
         ...
         */
        inline operator fun invoke(size: Long, init: (Long) -> Double): FastDoubleArray64 {
 ...
 */
private class FastDoubleArray64Iterator(private val array: FastDoubleArray64, index: Long) : DoubleArray64Iterator() {
    ...
    override fun setDouble(element: Double) {
