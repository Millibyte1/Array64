 ...
 *
 */
open class FastFloatArray64 : FloatArray64 {
    ...
    override operator fun iterator(): FloatArray64Iterator = Iterator(this, 0)
     ...
     */
    private class Iterator(private val array: FastFloatArray64, index: Long) : FloatArray64Iterator() {
